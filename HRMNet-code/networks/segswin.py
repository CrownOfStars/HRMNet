...
class SegSwinTransformer(nn.Module):
    ...
    def train(self, mode=True):
        ...
        super(SegSwinTransformer, self).train(mode)
        self._freeze_stages()
...
cfg_dict = {
    ...
    "segswin-base":["./pretrained/swin_base.pth","./pretrained/configs/segswin/segswin_base.yaml"],
...
if __name__ == '__main__':
    ...
    """
    SwinTransformer(img_size=config.DATA.IMG_SIZE,
    ...
    # msg = safe_load_model(model,state_dict['model'],ckpt_path)
    
    # print(model.state_dict()['norm0.weight'])
