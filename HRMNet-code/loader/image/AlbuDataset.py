...
def get_camo_loader(data_cfg, batchsize,  dist = False, ds_type='train', texture_type = None):
    if ds_type == 'train':
        train_datasets = []
        for dataset_name in data_cfg.TRAINSET:
            train_datasets.append(ISODTrainDataset(os.path.join(data_cfg.DATA_ROOT, ds_type, dataset_name),texture_type,data_cfg.IMG_SIZE))
        
        for dataset_name in data_cfg.ADDITIONSET:
            train_datasets.append(ISODTrainDataset(os.path.join(data_cfg.ADDITION_ROOT, ds_type, dataset_name),texture_type,data_cfg.IMG_SIZE, hard_aug = True))
        ...
        for dataset_name in data_cfg.VALSET:
            val_datasets.append(ISODValDataset(os.path.join(data_cfg.DATA_ROOT, ds_type, dataset_name),data_cfg.IMG_SIZE))
        ...
        for dataset_name in data_cfg.TESTSET:
            test_datasets.append(ISODTestDataset(os.path.join(data_cfg.DATA_ROOT, ds_type,dataset_name),data_cfg.IMG_SIZE))
